...
public class App {
    public static void main(String[] args) {
        ...
        ToDoList zadanie2 = new ToDoList("Zakupy chemii do detailingu", "ADBL Vampire, Fusso Soft99 Dark, ADBL Foam, Aqua APC, pedzelki Work Staff", Priority.HIGH, person1);
